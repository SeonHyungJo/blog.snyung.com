...
date: "2018-05-23"
update: "2019-12-11"
title: "CSS / BEM(Block Element Modifier)"
description: "어떤 CSS 방법론을 사용하는지에 따라 프로젝트의 형태와 규칙이 달라진다. 많은 방법론 중 BEM에 대해서 알아보자."
tags: ["CSS"]
category: "posts"
series: ""
---

어떤 CSS 방법론을 사용하는지에 따라 프로젝트의 형태와 규칙이 달라진다. 많은 방법론 중 **BEM**에 대해서 알아보자.
...
- 모든 블록에서 요소는 필수가 아닌 선택적으로 사용한다. **블록 안에 요소가 없을 수 있다.**
...
- 수식어는 단독으로 사용할 수 없다. **기본 블록과 요소에 추가하여 사용해야 한다.**
...
- [BEM_Naming](http://getbem.com/naming/)
