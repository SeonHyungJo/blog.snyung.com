...
![앱_개발에_유용한_Firebase_기능](/images/prevPosts/firebase/firebase_feature_main.png)
...
![App_Distribution_Main](/images/prevPosts/firebase/app_distribution_main.png)
...
![App_Distribution_Header_1](/images/prevPosts/firebase/app_distribution_header.png)
...
![App_Distribution_Header_2](/images/prevPosts/firebase/app_distribution_header_2.png)
...
![App_Distribution_Detail_1](/images/prevPosts/firebase/app_distribution_detail_1.png)

> 👆 App Distribution 메인 메뉴

![App_Distribution_Detail_2](/images/prevPosts/firebase/app_distribution_detail_2.png)
...
![App_Distribution_Detail_3](/images/prevPosts/firebase/app_distribution_detail_3.png)
...
![App_Distribution_Detail_3-1](/images/prevPosts/firebase/app_distribution_detail_3-1.png)

위에서 설정한 그룹 중 배포를 하고 싶은 그룹을 선택하면 대상 테스터들에게만 메일이 발송된다.

![App_Distribution_Detail_4](/images/prevPosts/firebase/app_distribution_detail_4.png)
...
![App_Distribution_Detail_5](/images/prevPosts/firebase/app_distribution_detail_5.png)

이후에도 추가 테스트 배포가 이루어지면 firebase에서 제공하는 페이지에서 원하는 버전으로 바로 다운받아볼 수 있다.

![App_Distribution_Detail_6](/images/prevPosts/firebase/app_distribution_detail_6.png)

![App_Distribution_Detail_7](/images/prevPosts/firebase/app_distribution_detail_7.png)

![App_Distribution_Detail_8](/images/prevPosts/firebase/app_distribution_detail_8.png)
...
![Remote Config 1](/images/prevPosts/firebase/remote_config_1.png)
...
![Remote Config 2](/images/prevPosts/firebase/remote_config_2.png)
...
![Remote Config 3](/images/prevPosts/firebase/remote_config_3.png)
