...
date: "2023-06-20"
update: "2023-06-20"
title: Next.js 13 / 8. Error Hadling
...
fallback error component가 활성화되면, error boundary 위의 레이아웃은 해당 상태를 유지하고 interactive를 유지하며, error component는 오류를 복구(recover)하는 기능을 표시할 수 있다.
