...
![swr_intro](/images/prevPosts/swr/SWR_Intro.png)

## intro

새로운 프로젝트를 하게 되면서, 프로젝트에 적용할 많은 새로운 스펙을  찾아보았고, **Preact + Vite**를 메인으로 사용하였다. 관련하여 글을 작성하였으니 궁금하면 [Preact, Vite 일주일 사용후기](/posts/2020-12-20--Preact%20Vite%20%EC%9D%BC%EC%A3%BC%EC%9D%BC%20%EC%82%AC%EC%9A%A9%ED%9B%84%EA%B8%B0)를 확인하길 바란다.
...
- Backend Agnostic
- Realtime
- [Jamstack](/posts/2021-01-08--JAMstack) Oriented
- TypeScript Ready
- Remote + Local
...
![swr_example](/images/prevPosts/swr/SWR_Example.png)
