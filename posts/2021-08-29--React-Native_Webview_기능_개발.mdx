...
![React_Native_Webview_기능_개발](/images/prevPosts/rn_webview/React_Native_Webview_Main.png)
...
![safe-area](/images/prevPosts/rn_webview/safe-area.png)
...
![App Icon xcassets](/images/prevPosts/rn_webview/app_icon_xcassets.png)

2. 안을 살펴보면 AppIcon을 추가하는 파일이 있다.

![App Icon IOS](/images/prevPosts/rn_webview/app_icon_ios.png)
...
![App Icon Android](/images/prevPosts/rn_webview/app_icon_android.png)
...
![Splash Image IOS 1](/images/prevPosts/rn_webview/splash_img_ios_1.png)

앱 이미지를 추가한 곳에서 동일하게 이미지를 추가할 수 있다.

![Splash Image IOS 2](/images/prevPosts/rn_webview/splash_img_ios_2.png)

하단에 + 를 클릭하여 Image Set을 선택해서 이미지를 추가한다.

![Splash Image IOS 3](/images/prevPosts/rn_webview/splash_img_ios_3.png)

사진과 같이 1, 2, 3배율 사진을 넣으라고 한다. 스플래시 이미지로 사용할 이미지를 추가한다.

![Splash Image IOS 4](/images/prevPosts/rn_webview/splash_img_ios_4.png)
...
![Change APP Name IOS](/images/prevPosts/rn_webview/app_name_ios.png)
...
![APP Store Link](/images/prevPosts/rn_webview/app_store_link.png)
