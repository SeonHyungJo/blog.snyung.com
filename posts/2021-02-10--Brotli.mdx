...
![snyung - brotli logo](/images/prevPosts/brotli/brotli_logo.png)
...
![snyung - can i use : brotli](/images/prevPosts/brotli/caniuse-brotli.png)
> Can I Use - Brolti
...
![snyung - cloudfront 1](/images/prevPosts/brotli/cloudfront-1.png)
...
![snyung - cloudfront 2](/images/prevPosts/brotli/cloudfront-2.png)

중간에 위치한 Cache Policy 항목에서 **Managed-CachingOptimized** 를 선택하게 되면 Gzip과 Brolti를 둘 다 제공하게 된다.

> 자신만의 Policy를 만들어서 설정하셔도 됩니다.

![snyung - cloudfront 4](/images/prevPosts/brotli/cloudfront-4.png)
...
![snyung - cloudfront 3](/images/prevPosts/brotli/cloudfront-3.png)
...
![snyung - cloudfront test 1](/images/prevPosts/brotli/test-1.png)

초기 사진을 보게 되면 사이즈부터 **1.2MB**인 것을 확인할 수 있다. 한 파일을 내려받는데 **233ms**로 아주 느리지 않다고 생각할 수 있지만 압축된 모습을 보게 되면 느리다고 생각할 수 있다.

![snyung - cloudfront test 2](/images/prevPosts/brotli/test-2.png)
...
![snyung - cloudfront test 3](/images/prevPosts/brotli/test-3.png)
