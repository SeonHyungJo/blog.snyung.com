...
- 웹, 앱개발, 사내 업무 자동화등 **고객과 내부구성원 모두**를 위한 개발을 해왔습니다.
- 개발에도 관심이 있지만 **비즈니스 성장에도 관심**이 있습니다.
- 개인이 아닌 구성원들과의 **커뮤니케이션과 협업을 중요시**합니다.
- 2년간 초기 MVP 개발부터 배포, 운영하여 100만명이 넘는 사용자를 모으며 수익모델을 만들고 3번의 투자와 개발자 리드한 경험이 있습니다.

## Skill.

- React(Next.js),React(Next.js), Vue.js, Nx, TypeScript, Preact, emotion, stitches
- react-query, SWR, Jotai, Recoil
- React Native
- Google Analytics, GTM, Cohere
- Github Action, AWS (Beanstalk, S3, EB, Lambda 등)
...
- 일관성 있는 디자인을 가져가기 위해 디자이너와 상의하여 **디자인 시스템 도입**.
...
- 이벤트 트래킹을 위해 정의하는 이름을 짓는 법 논의 및 문서화
- 앱 트래킹을 위한 GA4 적용
