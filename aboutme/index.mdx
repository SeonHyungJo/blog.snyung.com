...
| **# LinkedIn** | [https://www.linkedin.com/in/snyung](https://www.linkedin.com/in/snyung/)|
...
- 웹 개발, 크로스플랫폼 앱 개발, 사내 업무 자동화 등 **고객과 내부구성원 모두**를 위한 개발해왔습니다.
- 개발에도 관심이 있지만 **비즈니스 성장에도 관심**있습니다.
- 개인이 아닌 구성원들과의 **커뮤니케이션과 협업을 중요시**합니다.
- **글로벌 서비스 앱, 웹을 초기부터 만들고 배포, 운영한 경험**이 있습니다.
...
<Collapsible title="Nsuslab(앤서스랩코리아) - 23.08 ~ 현재" defaultOpen={true}>
...
| projects | Casino Web 개발 및 배포 |
| tech | Typescript, NextJS, react-query, Zustand, Tailwind, Zod |

### Casino Web 개발 및 배포

- iGaming. 러시아 타겟 웹 배포
- 기존 카지노 앱과 동일한 Monorepo 환경에서 웹 개발
- NextJS 기반 SSR 웹 개발
- 회사 Game Team과 협업하여 게임 연동
- 회사 Account Team과 협업하여 Auth 연동
- Github을 이용한 빌드 및 배포 자동화
- FSD 폴더구조 적용
- 다국어 처리
- Sentry를 이용한 웹 이슈 트래킹 적용

| | |
| - | ---- |
| period | 24.10 ~ 25.04 |
| position | Sofeware Engineer |
| projects | 카지노 플랫폼 App 개발 및 배포 |
| tech | Typescript, React-Native, React, react-query, Zustand, Unistyles, Zod |

### 카지노 플랫폼 앱 개발 및 배포

- iGaming. 캐나다 타겟 앱 배포
- Monorepo 환경에서 앱과 웹의 공통 컴포넌트 관리
- React-Native 기반 크로스플랫폼 앱 개발
- React-Native Webview를 이용한 화면 구성
- React을 이용한 화면 웹 개발
- 최대 동시 4개의 게임 플레이 화면 개발
- 회사 Game Team과 협업하여 게임 연동
- 회사 Account Team과 협업하여 Auth 연동
- OneSignal을 이용한 푸시 알림 개발
- Jenkins를 이용한 빌드 및 배포 자동화
- zx를 이용한 다양한 빌드, 배포 Script 구성
- FSD 폴더구조 적용
- 다국어 처리
- Sentry를 이용한 모바일 이슈 트래킹 적용

| | |
| - | ---- |
| period | 23.08 ~ 24.09 |
| position | Sofeware Engineer |
| projects | 카지노 플랫폼 App POC |
...
- FSD 폴더구조 적용
- zx를 이용한 다양한 Sheet Script 구성
- re.pack을 이용한 페이지 단위 배포 테스트

</Collapsible>

<Collapsible title="Callbuslab(콜버스랩) - 20.04 ~ 23.03">
...
<Collapsible title="Inswave Systems(인스웹이브 시스템즈) - 18.04 ~ 20.04">
...
- 2025 [무한도전 마라톤 - 2025 SEOUL](https://www.coupangplay.com/promotion/2025MudorunSeoul/) 10KM 참가
